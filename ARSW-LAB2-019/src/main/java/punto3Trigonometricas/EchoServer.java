    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((inputLine = in .readLine()) != null) {
            ...
            if(inputLine.contains("fun:")){
                ...
                if(tipo=="sin"){
                rest = Double.toString(Math.sin(Math.toRadians(Double.parseDouble(inputLine))));
                
                }else if(tipo=="tan"){
                    rest = Double.toString(Math.tan(Math.toRadians(Double.parseDouble(inputLine))));
                }
                else{
                    rest = Double.toString(Math.cos(Math.toRadians(Double.parseDouble(inputLine))));
                }
            }
